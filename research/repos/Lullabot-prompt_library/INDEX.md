# Lullabot-prompt_library — Structural Index

**Source URL**: https://github.com/Lullabot/prompt_library
**Clone URL used**: https://github.com/Lullabot/prompt_library
**Last commit**: 2026-04-15 09:49:40 -0700
**Last commit subject**: Merge pull request #133 from Lullabot/skill-copy-only-actions
**License**: none
...
- skills.yaml: ✗ absent
- .cursorrules / .cursor/ : ✓ present (.cursor)
- .github/ : ✓ present
